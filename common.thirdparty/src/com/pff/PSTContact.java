...
public class PSTContact extends PSTMessage {
    ...
    /**
     * Contacts generational abbreviation FTK: Name suffix
     */
    ...
    /**
     * Contacts surname FTK: Last name
     */
    ...
    /**
     * Contacts job title FTK: Profession
     */
    ...
    /**
     * Contacts department name Used in contact item
     */
    ...
    /**
     * Contacts secondary office (business) phone number
     */
    ...
    /**
     * Contacts office (business) fax number
     */
    ...
    public String toString() {
        ...
        return "Contacts Account name: " + getAccount()
                + "\n"
                + "Display Name: "
                + getGivenName()
                + " "
                ...
                + "\n"
                + "Contacts generational abbreviation (name suffix): "
                + getGeneration()
                + "\n"
                + "Contacts given name: "
                + getGivenName()
                ...
                + getCompanyName()
                + "\n"
                + "Contacts job title (Profession): "
                + getTitle()
                + "\n"
                + "Contacts department name  Used in contact ite: "
                + getDepartmentName()
                + "\n"
                + "Contacts office location: "
                + getOfficeLocation()
                ...
                + getPrimaryFaxNumber()
                + "\n"
                + "Contacts office (business) fax numbe: "
