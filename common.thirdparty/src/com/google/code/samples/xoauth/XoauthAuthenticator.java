...
public class XoauthAuthenticator {
	public static final class XoauthProvider extends Provider {
		private static final long serialVersionUID = 6075123718953596108L;
	...
	/**
	 * Generates a new OAuthConsumer with token and secret of "anonymous"/"anonymous". This can be used for testing.
	 */
	...
	/**
	 * Installs the XOAUTH SASL provider. This must be called exactly once before calling other methods on this class.
	 */
	...
	public static SMTPTransport connectToSmtp(String host, int port, String userEmail, String oauthToken,
		...
		/*
		 * I couldn't get the SASL infrastructure to work with JavaMail 1.4.3; I don't think it was ready yet in that release. So
		 * we'll construct the AUTH command manually.
		 */
	...
	// initialize();
	//
	// IMAPSSLStore imapSslStore = connectToImap("imap.googlemail.com", 993,
	// email, oauthToken, oauthTokenSecret,
	// getAnonymousConsumer(), true);
	// System.out.println("Successfully authenticated to IMAP.\n");
	// SMTPTransport smtpTransport = connectToSmtp("smtp.googlemail.com", 587,
	// email, oauthToken, oauthTokenSecret,
	// getAnonymousConsumer(), true);
