...
import org.subethamail.smtp.SmtpSessionFactory;
...
public class SMTPServer {
     ...
     *            enforces it only selectively. Use {@link Session#isAuthenticated} to check whether the client
    ...
    public SMTPServer(MessageHandlerFactory msgHandlerFact,
        ...
        this(msgHandlerFact, authHandlerFact, executorService, null);
    }
     ...
     * <p>
     * Subclasses may override this method to configure the key stores, enabled protocols/ cipher suites, enforce client
     * authentication, etc.
     * 
     * @param socket
     *            the existing socket as created by {@link #createServerSocket()} (not null)
     * @return a SSLSocket
     * @throws IOException
     ...
     * <ul>
     * <li>javax.net.ssl.keyStore system property must refer to a file containing a JKS keystore with the private key.
     * <li>javax.net.ssl.keyStorePassword system property must specify the keystore password.
     * </ul>
     * <p>
     * Up to SubEthaSMTP 3.1.5 the default was true, i.e. TLS was enabled.
     * 
     * @see <a href="http://blog.jteam.nl/2009/11/10/securing-connections-with-tls/">Securing Connections with TLS</a>
     */
