...
public class Session implements Runnable, MessageContext {
    ...
    /**
     * HA PROXY information
     */

    private String haProxyProtocol;
    private String haProxySourceAddress;
    private String haProxyDestinationAddress;
    private int haProxySourcePort;
    private int haProxyDestinationPort;
    ...
    public void setHaProxyInfo(String protocol,
                               String sourceAddress,
                               String destinationAddress,
                               int sourcePort,
                               int destinationPort) {
        haProxyProtocol = protocol;
        haProxySourceAddress = sourceAddress;
        haProxyDestinationAddress = destinationAddress;
        haProxySourcePort = sourcePort;
        haProxyDestinationPort = destinationPort;
    }

    public String getHaProxyProtocol() {
        return haProxyProtocol;
    }

    public String getHaProxySourceAddress() {
        return haProxySourceAddress;
    }

    public String getHaProxyDestinationAddress() {
        return haProxyDestinationAddress;
    }

    public int getHaProxySourcePort() {
        return haProxySourcePort;
    }

    public int getHaProxyDestinationPort() {
        return haProxyDestinationPort;
    }
}
