/*
 * $Id: MessageContext.java 355 2009-10-06 16:26:00Z lhoriman $
 * $URL: https://subethasmtp.googlecode.com/svn/trunk/src/main/java/org/subethamail/smtp/MessageContext.java $
 */
...
public interface MessageContext {
    ...
    String getHaProxyProtocol();

    String getHaProxySourceAddress();

    String getHaProxyDestinationAddress();

    int getHaProxySourcePort();

    int getHaProxyDestinationPort();
